      ...
      <div className="w-full max-w-md">
        <div className="flex items-center justify-center gap-2.5 mb-8">
          ...
          <div className="text-parchment leading-tight">
            ...
            <div className="text-[10px] uppercase tracking-wider text-brass-light">Secure Staff & Institution Sign-In</div>
          </div>
        </div>
          ...
          {stage === 'credentials' && (
            <>
              ...
              <div className="mt-5 pt-5 border-t border-line">
                <button onClick={() => setShowDemoList((s) => !s)} className="text-xs text-brass-dark hover:underline">
                  ...
                  <div className="mt-3 grid grid-cols-1 gap-1.5 max-h-64 overflow-y-auto">
                    {DEMO_ACCOUNTS.map((acc) => (
                      <button
                        ...
                        className="text-left text-xs px-3 py-2 rounded border border-line hover:border-brass hover:bg-brass/5 transition-colors"
                      >
