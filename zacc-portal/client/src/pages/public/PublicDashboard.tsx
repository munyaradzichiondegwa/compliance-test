  ...
  return (
    <div className="min-h-screen bg-parchment">
      ...
      <main className="max-w-6xl mx-auto px-5 py-10">
        ...
        <h1 className="font-display text-2xl md:text-3xl font-semibold text-navy mb-2">Institutional compliance, by province</h1>
          ...
          <div className="grid lg:grid-cols-[1fr_320px] gap-8">
            ...
            <div className="space-y-4">
              <div className="card p-5">
                ...
                <div className="text-3xl font-display font-semibold text-navy mt-1">{totalInstitutions}</div>
              </div>
              <div className="card p-5">
