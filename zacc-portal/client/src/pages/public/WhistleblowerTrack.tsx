  ...
  return (
    <div className="min-h-screen bg-parchment">
      ...
      <main className="max-w-lg mx-auto px-5 py-14">
        <h1 className="font-display text-2xl font-semibold text-navy mb-2 text-center">Check your report status</h1>
        ...
        {result && (
          <div className="card p-6 mt-4">
            <div className="flex items-center justify-between mb-4">
              <span className="font-mono text-sm text-navy">{result.trackingCode}</span>
