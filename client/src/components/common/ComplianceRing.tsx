...
const SEGMENTS = [
  { key: 'governance', label: 'Governance', weight: 0.2, color: '#161512' },
  { key: 'controls', label: 'Internal Controls', weight: 0.25, color: '#5C5850' },
  { key: 'procurement', label: 'Procurement', weight: 0.2, color: '#A87D1E' },
  { key: 'finance', label: 'Financial Mgmt', weight: 0.2, color: '#D9A62E' },
  { key: 'integrity', label: 'Integrity', weight: 0.15, color: '#CE1126' },
];
