          ...
          {canEdit && (
            <Card>
              ...
              <div className="h-1.5 bg-line rounded-full overflow-hidden">
                <div className="h-full bg-gold transition-all" style={{ width: `${(answeredCount / data.items.length) * 100}%` }} />
              </div>
            </Card>
          )}
          <Card>
        ...
        <div className="space-y-6">
          {canReview && (
            <Card className="border-gold/40 bg-gold/5">
              <div className="text-xs uppercase tracking-wide text-gold-dark mb-2 font-semibold">Supervisor Review</div>
          ...
          {['governance', 'controls', 'procurement', 'finance', 'integrity'].map((section) => (
            <Card key={section}>
              <div className="font-display font-semibold text-charcoal mb-4">{SECTION_LABELS[section]}</div>
              <div className="space-y-4">
          ...
          <Card>
            <div className="flex items-center justify-between mb-3">
              <div className="font-display font-semibold text-charcoal">Findings Narrative</div>
              {canEdit && (
          ...
          {data.recommendations?.length > 0 && (
            <Card>
              <div className="font-display font-semibold text-charcoal mb-3">Implementation Matrix</div>
          ...
          {canEdit && (
            <button onClick={submitAssessment} disabled={submitting || answeredCount < data.items.length} className="btn-gold w-full py-3">
