    ...
    <div className="min-h-screen bg-parchment text-ink">
      ...
      <header className="border-b border-line bg-paper/80 backdrop-blur sticky top-0 z-30">
        <div className="max-w-6xl mx-auto px-5 h-16 flex items-center gap-3">
          ...
          <div className="leading-tight">
            ...
            <div className="text-[10px] uppercase tracking-wider text-gold-dark">Institutional Integrity, Made Visible</div>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-5 pt-14 pb-16 md:pt-20 md:pb-24 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h1 className="font-display text-4xl md:text-5xl font-semibold leading-[1.08] text-charcoal">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link to="/whistleblower/report" className="btn-gold">
      ...
      <section className="bg-charcoal text-parchment py-16">
        <div className="max-w-6xl mx-auto px-5">
          <div className="eyebrow !text-gold-light mb-2">The Assessment Lifecycle</div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {[
              ...
              <div key={stage} className="relative">
                <div className="text-gold-light font-mono text-xs mb-2">{String(i + 1).padStart(2, '0')}</div>
      ...
      <section className="max-w-6xl mx-auto px-5 py-16">
        ...
        <h2 className="font-display text-2xl md:text-3xl font-semibold text-charcoal mb-10 max-w-xl">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            <div key={title} className="card p-5">
              <Icon size={20} className="text-gold mb-3" strokeWidth={1.75} />
      ...
      <footer className="border-t border-line py-8 text-center text-xs text-slate">
        <div className="max-w-6xl mx-auto px-5 flex flex-col sm:flex-row items-center justify-center gap-2">
          ...
          <Link to="/whistleblower/track" className="hover:text-gold-dark underline">Track a report</Link>
        </div>
      </footer>
    </div>
  );
